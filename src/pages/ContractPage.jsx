  ...
  return (
    <>
      <div className="w-full bg-white p-10">
        <h1 className="text-center text-2xl font-bold">반려동물 분양 계약서</h1>

        <div className="mt-10 flex flex-col gap-5">
          <h2 className="font-semibold">기본 조항</h2>
          <p>
            본 계약서는 분양인과 입양인 사이의 계약을 명시하며 분양인과 입양인은
            반려동물분양 이후 아래와 같은 문제 발생시 보상규정에 따른 보상 또는
            법적인 책임을 질 의무가 있다.
          </p>
          ...
          <p>
            ...
            분양한 반려동물에 대해 다음과 같이 “갑”과 “을” 간에 계약을 체결한다.
          </p>

          <p>
            2. “갑”은 “을 ”에게 무료 또는 적정의 책임비용을 받고 키우던
            반려동물을 분양하며, “을” 은 반려동물을 입양한 날로부터 ___개월(이하
            “책임기간” 이라함) 이내에, 분양받은 반려동물을 다른 사람 손에
            맏기거나 팔아서는 아니된다.
          </p>

          <p>
            3. “을”은 신의에 입각하여 아래와 같이 서약한다. ᄀ. “책임기간” 내,
            반려동물은 “을”의 양육권 하에 “갑”과 “을” 공동소유임을 확약한다. ᄂ.
            “책임기간” 내, 부득이한 사정 또는 사고로 분양받은 반려동물을 처분할
            시에는 “갑”에게 알릴 의무가 있다. ᄃ. “책임기간” 내 재분양이 있을
            경우, “갑”의 허락 및 새로운 입양자의 연락처를 알려주어야 한다. ᄅ.
            “책임기간” 내 재분양이 있을 경우, “갑”이 허락하지 않는다면, “을”은
            반려동물을 그대로 키우거나 “갑”에게 아무 조건없이 돌려주어야 한다.
            ᄆ.“갑”은 “책임기간” 이내 해당 날짜를 공식적으로 확인할 수 있는
            반려동물에 대한 인증모습(사진, 동영상)을 요구할 수 있으며 “을”은
            “을”에게 편한 방법으로 반려동물 인증모습을 제공할 의무가 있다.
          </p>

          <p>
            4. “갑”이 “을” 에게 제공했던 정보와 “을”이 입양했던 반려동물의
            정보가 치명적으로 일치하지 않을 경우에는 “을”은 1달 이내에, “갑”에게
